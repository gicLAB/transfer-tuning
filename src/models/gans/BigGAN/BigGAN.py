...
import src.models.gans.BigGAN.layers as layers
from src.models.gans.BigGAN.sync_batchnorm import (
    SynchronizedBatchNorm2d as SyncBatchNorm2d,
)
    ...
    def forward(self, z, y):
        ...
        for index, blocklist in enumerate(self.blocks):
            ...
            for block in blocklist:
                print("we are running block", qqq)
                print(h.shape, ys[index].shape)
                print(ys[index])
                qqq += 1
                h = block(h, ys[index])
